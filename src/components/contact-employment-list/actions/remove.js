...
export default class {
  ...
  success () {
    ...
    let targ = document.querySelector(`.employment-section-${this.opt.id}`)
  ...
  async remove (e) {
    ...
    return this.xhr.__deleteData(`contact/employment/${this.opt.id}`, {}, this.__headers, false).then(res => {
