...
export default class {
  ...
  success () {
    ...
    let targ = document.querySelector(`.engagement-section-${this.opt.id}`)
  ...
  async remove (e) {
    ...
    return this.xhr.__deleteData(`contact/engagement/${this.opt.id}`, {}, this.__headers, false).then(res => {
