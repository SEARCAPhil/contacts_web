...
export default class {
  ...
  success () {
    ...
    let targ = document.querySelector(`.conf-lect-section-${this.opt.id}`)
  ...
  async remove (e) {
    ...
    return this.xhr.__deleteData(`contact/conference/lecture/${this.opt.id}`, {}, this.__headers, false).then(res => {
