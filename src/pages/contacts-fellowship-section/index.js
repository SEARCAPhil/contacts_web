...
export default class {
  ...
  async search (opt) {
    ...
    return this.xhr.__getData(`contact/filter/fellowship/search/${opt.param}?page=${opt.page ? opt.page : 1}`, this.__headers)
  }
  ...
  async __getContacts (opt = {}) {
    const __contacts = (await import('../../components/contact-fellowship-com-list/actions/retrieve')).default
  ...
  async render () {
    this.__contactComponent = (await import('../../components/contact-fellowship-com-list')).default
    ...
    <section class="content-header">
      ...
      <div class="media">
        <div class="media-left">
          <span>
            <img class="media-object" src="assets/img/fellow.png" alt="..." width="50px">
          </span>
        </div>
        <div class="media-body">
          <h4 class="media-heading">Fellows</h4>Individuals who are or have been appointed as Senior Fellows, <br/>Visiting Research Fellows, or Adjunct Fellows of the Center.</div>
      </div>
