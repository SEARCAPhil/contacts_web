      ...
      <div class="home-section-text">
        <section class="col col-xs-12 col-lg-12 col-md-12">
          ...
          <!-- home -->
            <div>
              <center>
                <img data-src="assets/img/people.png" width="250px" class="tns-lazy-img"/>
                <h3>Contacts Web Database</h3>
                <p>You can easily search affiliates with just a snap. <br/>
                Looking for someon to work with is o much easier now. Start exploring the app!</p>
              </center>
            </div>
            ...
            <div>
              <center>
                ...
                <p>
                  ...
                  Just go to > <b>Settings > Install Contacts Web Portal</b>              
                </p>
              </center>
            </div>
